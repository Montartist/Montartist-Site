...
async function createMenuBar(menuBarObj) {
	...
	var portfolioParticipants  = await dataLoad.requestJSON('https://montartist.net/files/data/portfolio.json')
	...
	menuConcours.addEventListener("focus", function () {menuConcours.innerHTML = 'CONCOURS <div id="subConcours" class="subMenu"><ul class="subMenu"><li class="subItem"><a href="https://montartist.net/Concours/Participants">Participants</a></li><li class="subItem"><a href="https://montartist.net/Concours/Selectionnes">Sélectionnés</a></li></ul></div>'; })
	menuPortfolio.addEventListener("focus", function () {
		...
		for (var participant of Object.keys(portfolioParticipants)) {
			...
			a.setAttribute('href', `https://montartist.net/Portfolio/${participant}`)
			li.appendChild(a)
